...
import About from "../ComponentKajan/About";
import Footer from "../ComponentKajan/HomeFooter";


import Services from "../ComponentKajan/Services";
    ...
    render() { 
        return (
            ...
            <div>
                ...
                <div className="row">
                    <div style={{position:"relative",left:"200px"}} className="col-lg-6 mt-5 d-flex flex-column p-4">
