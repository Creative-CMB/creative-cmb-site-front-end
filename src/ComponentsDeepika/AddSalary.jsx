        ...
        return (
            <div>
                ...
                <div className="col main">
                    ...
                    <br></br>
                <h1 style={{color: "DodgerBlue", fontSize: '30px',fontWeight:"bold"}}><center>ADD SALARY DETAILS</center></h1><br></br><br></br>
                <div style={{ padding: "30px",background: "#ececec"}}>
                <Row gutter={50}>
                <Col span={12}>
                    <Card >
                    <form style={{fontWeight:"bold"}}>
                    Employee ID : <input style={{border: "3px solid #ccc",float: "right",width: "68%"}} type="text" onChange= {this.formData} name="Employee_Name" ></input><br></br><br></br>
                    Department ID : <input style={{border: "3px solid #ccc",float: "right",width: "68%"}} type="text"onChange= {this.formData} name="Dept_Name"></input><br></br><br></br><br></br>
                ...
                <Col span={12}>
                    <Card >
                        ...
                        Paid : <input style={{border: "3px solid #ccc"}} type="checkbox" checked={this.state.condition} onChange= {this.formData} name="Paid"></input><br></br><br></br>
