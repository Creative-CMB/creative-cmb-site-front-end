    ...
    render() {
        return (
            <div>
                ...
                <h1 style={{color: "DodgerBlue", fontSize: '30px',fontWeight:"bold"}}><center>ADD LEAVES</center></h1><br></br>
                ...
                <Col span={12}>
                    ...
                    Employee Name : <input style={{border: "3px solid #ccc",float: "right",width: "68%"}} type="text" onChange= {this.formData} name="empname" ></input><br></br><br></br>
                    Department Name : <input style={{border: "3px solid #ccc",float: "right",width: "68%"}} type="text"onChange= {this.formData} name="deptname"></input><br></br><br></br><br></br>
                ...
                <Col span={12}>
                    <Card >
                        ...
                        Accepted : <input style={{border: "3px solid #ccc"}} type="checkbox" checked={this.state.condition} onChange= {this.formData} name="Accepted"></input><br></br><br></br>
